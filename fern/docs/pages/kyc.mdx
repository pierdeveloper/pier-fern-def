...
You can override a borrower's status at borrower creation time or any time for testing purposes. Please see the [`/borrowers/consumer`](/api-reference/borrowers/create-consumer-borrower) creation and [`/borrowers/consumer`](/api-reference/borrowers/update-a-consumer-borrower#update_consumer_borrower-request-kyc_status) update endpoints for more information.
